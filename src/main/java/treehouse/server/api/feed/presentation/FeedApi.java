package treehouse.server.api.feed.presentation;
...
import treehouse.server.api.feed.business.FeedService;
...
public class FeedApi {
    ...
    public CommonResponse<FeedResponseDto.getFeedDetails> getFeedDetails(
            @PathVariable Long treehouseId,
            @PathVariable Long postId,
            @AuthMember @Parameter(hidden = true) User user
    ){
        return CommonResponse.onSuccess(feedService.getFeedDetails(user, postId, treehouseId));
    }
}
